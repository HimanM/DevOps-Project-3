...
import { X, ZoomIn, Terminal, Network } from "lucide-react"

export function KubectlSetup() {
        ...
        <div className="space-y-16">
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6">
                    <GalleryItem
                        src="/screenshots/kubectl-get-all.png"
                        title="Kubectl Get All"
                        delay={0}
                        onClick={() => setSelectedImage({ src: "/screenshots/kubectl-get-all.png", title: "Kubectl Get All Output" })}
                        icon={<Terminal className="h-4 w-4 text-green-400" />}
                    />
                    <GalleryItem
                        src="/screenshots/kubectl-ingress.png"
                        title="Ingress Configuration"
                        delay={0.1}
                        onClick={() => setSelectedImage({ src: "/screenshots/kubectl-ingress.png", title: "Ingress Configuration" })}
